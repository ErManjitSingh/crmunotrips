...
const { processEndOfDayCheckout } = require('./attendanceService');
...
function startNotificationScheduler() {
  ...
  console.log('[NotificationScheduler] Started (reminders, missed, escalations, connected→WIP, attendance EOD)');
