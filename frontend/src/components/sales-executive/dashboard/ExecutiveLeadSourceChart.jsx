import { Globe, MessageCircle, Phone, ClipboardList, Users, MoreHorizontal } from 'lucide-react';
...
const SOURCE_ICONS = {
  DPW: ClipboardList,
  'DPW WA': WhatsAppSourceIcon,
  'DPW CALL': Phone,
  DPW2: ClipboardList,
  'DPW2 WA': WhatsAppSourceIcon,
  'DPW2 CALL': Phone,
  Referral: Users,
  'Call Lead': Phone,
  Organic: Globe,
  Website: ClipboardList,
  WhatsApp: WhatsAppSourceIcon,
  Facebook: ClipboardList,
  'Facebook Lead': ClipboardList,
};
