      ...
      {cards.map((kpi, index) => {
        ...
        return (
          <motion.div
            ...
            className={cn(
              'group relative flex flex-col rounded-[20px] border border-slate-200/80 bg-white',
              'p-4 min-h-[138px] shadow-[0_1px_3px_rgba(15,23,42,0.04)]',
          ...
          >
            ...
            <p className="text-[11px] font-medium text-slate-500 mb-1">{kpi.label}</p>
            <p className="text-[22px] font-bold text-slate-900 metric-tabular tracking-tight leading-none">
              {kpi.value}
            </p>
            <p className="text-[10px] text-slate-400 mt-1 mb-2">vs last month</p>

            {chartData.length > 0 && (
              <div className="h-9 -mx-1 mt-auto opacity-80 group-hover:opacity-100 transition-opacity">
